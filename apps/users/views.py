...
class ActiveUserView(View):
    ...
    def get(self,request,active_code):
        ...
        if all_records:
            ...
            return render(request,'active_fiald.html')
...
class ForgetPwdView(View):
    ...
    def post(self,request):
        ...
        if forget_form.is_valid():
            ...
            get_email = UserProfile.objects.filter(email=email)
            if not get_email:
                return render(request, 'forgetpwd.html', {'forget_form':forget_form,'msg':u'用户未注册'})
...
#             return render(request,'index.html')
#         else:
#             return render(request, 'login.html',{'msg':'用户名或者密吗错误！'})
